...
\begin{frame}{Amendment names vs.\ Wi-Fi generations}
  ...
  {\scriptsize\textcolor{softgray}{IEEE names amendments; the Wi-Fi Alliance names
    generations. Wi-Fi 1--3 are retroactive, informal labels.}\par}

  \vspace{0.25em}
  \takeaway{One radio, two naming systems: engineering (IEEE)\\
    and marketing (Wi-Fi Alliance). The orange row is a parallel branch.}

  \glossline{HT/VHT/HE/EHT = High / Very High / High-Efficiency / Extremely High
    Throughput \quad MLO = Multi-Link Operation}
