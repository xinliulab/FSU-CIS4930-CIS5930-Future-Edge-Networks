...
% Teaching note (150 s): treat the maxima as comparison anchors, not promises. The
% years are standard milestones; certification and shipping dates differ. Standards
% allow configurations beyond what typical phones and APs implement. Point at how each
% row's "key PHY idea" maps back to the resource-dimension table from slide one.
\begin{frame}{The mainstream branch, b to be}
  ...
  \begin{tabular}{@{}llllll@{}}
    ...
    \midrule
    % The "key PHY idea" column is ranblue on purpose: it is the reading path.
  ...
  {\scriptsize\textcolor{softgray}{Years are amendment approval; 802.11be published
    July 2025. \enspace * 6 GHz operation is in 802.11ax-2021; availability depends
    on national regulation (Wi-Fi 6E). \enspace $\dagger$ Required mode at the MAC
    data SAP; peak PHY rate $\approx$46 Gb/s.}\par}

  \vspace{0.5em}
  \takeaway{Maxima are comparison anchors, not promised throughput.\\
    Standards allow more than typical devices ever implement.}
