...
\begin{frame}{802.11a: many orthogonal subcarriers}
  ...
  {\scriptsize\textcolor{softgray}{No magic: spacing = 1 / symbol time, so between
    samples each neighbor completes exactly one extra full cycle and sums to zero.
    You met OFDM in Class 3 (LTE) --- same idea, 20 MHz at a time.}\par}
