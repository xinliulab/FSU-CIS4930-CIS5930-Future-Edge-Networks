...
\begin{frame}
  ...
  \vspace{0.45em}
  \large
  Can we use \textbf{ChatGPT, Claude, Gemini, Copilot, DeepSeek, etc.} \\ to help with assignments?

  \vspace{0.7em}
  \includegraphics[width=0.96\linewidth]{figure/ai_infinity_stones_models.png}
\end{frame}
