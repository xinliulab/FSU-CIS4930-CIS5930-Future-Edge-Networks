...
% Nav short name is Market, not Money: only three of these eight frames are about
% cost. Consolidation, viability, Wi-Fi, Starlink, and coverage-vs-capacity are market
% structure, and money is the input rather than the subject. Not "Competitor" either --
% that names three frames, and the coverage-vs-capacity frame argues the opposite,
% that satellites and towers sell different products rather than compete.
% The displayed section title stays a question; the nav word is the umbrella.
\section[Market]{Does Any of This Make Money?}
