...
\begin{frame}{Monday's open question}
  ...
  \begin{tikzpicture}[scale=0.9,transform shape]
    ...
    \node[font=\small,anchor=south] at (2.7,0.7) {revenue per line: flat, slightly down};
    \draw[flow,draw=coreorange,very thick] (0,-0.6) -- (5.4,0.35);
    \node[font=\small,anchor=north] at (2.7,-0.7) {spending on the network: up};
  \end{tikzpicture}
...
% SOURCE: Verizon 2025 consolidated capex guidance $17.5-18.5B.
...
\begin{frame}{Roughly where a fifth of your bill goes}
  ...
  \begin{tabular}{@{}r@{\hspace{0.5em}}l@{}}
    \textcolor{coreorange}{\textbf{\$18 billion}} & a year of network construction\\[4pt]
    \textcolor{softgray}{$\div$} & \\[4pt]
    \textcolor{ranblue}{\textbf{126 million}} & postpaid connections\\[6pt]
    \midrule
    $\approx$ \textbf{\$12} & per connection per month\\
  \end{tabular}\par}
  ...
  {\scriptsize\textcolor{softgray}{Deliberately crude: consolidated capex covers
   ...
   just phones. Verizon, 2025 guidance and Q1 2025 connections.}\par}
\end{frame}
