...
% SECTION TIMING: 58:00--73:00 (8 frames). This section closes the loop opened by the
% two money frames on Monday. End the course meeting on the Starlink question, not on a
% summary -- it is the one students will actually go look up afterwards.
%
...
\begin{frame}{Monday's open question}
  \vspace{0.6em}
  \centering
...
% Back-of-envelope. Inputs:
% SOURCE: Verizon FY2025 ACTUAL consolidated capex $17.0B. FY2026 guidance is
%   $16.0-16.5B -- Verizon capex has fallen two years running.
%   https://www.verizon.com/about/news/verizon-delivers-2025-financial-guidance-highest-quarterly-net-adds
% This frame is about MAGNITUDE, not direction. The "spend is rising" claim belongs to
%   Monday's frame and is AT&T's. Do not let this slide imply Verizon capex is rising.
% SOURCE: Verizon wireless retail postpaid CONNECTIONS ~125.8M as of 2025-03-31
%   (94.9M Consumer + 30.9M Business). Connections, not phones -- includes tablets,
%   watches, and other devices. https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=0000732712
% The division below is deliberately crude and is labeled as such on the slide.
\begin{frame}{Roughly where a fifth of your bill goes}
  \vspace{0.4em}
  \centering
  {\large
  \begin{tabular}{@{}r@{\hspace{0.5em}}l@{}}
    \textcolor{coreorange}{\textbf{\$17 billion}} & a year of network construction\\[4pt]
    \textcolor{softgray}{$\div$} & \\[4pt]
    \textcolor{ranblue}{\textbf{126 million}} & postpaid connections\\[6pt]
    \midrule
    $\approx$ \textbf{\$11} & per connection per month\\
  \end{tabular}\par}

  \vspace{0.9em}
  \small
  Against a bill of roughly \$50, that is about a fifth of what you pay going
  straight back into towers, spectrum, fiber, and power.

  \vspace{0.5em}
  {\scriptsize\textcolor{softgray}{Deliberately crude: consolidated capex covers
   broadband and business too, and ``connections'' counts tablets and watches, not
   just phones. Verizon FY2025 actual capex and Q1 2025 connections.}\par}
\end{frame}
...
\begin{frame}{The competitor in orbit}
  ...
  \vspace{0.7em}
  {\scriptsize\textcolor{softgray}{As of late June 2026. This story is two months
   old and still moving --- check what has happened since.}\par}
...
\begin{frame}{The question to leave with}
  ...
  \centering
  \Large
  Every architecture change in these two lectures\\
