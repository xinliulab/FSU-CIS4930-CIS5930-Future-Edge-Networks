...
% SECTION TIMING: 08:00--11:00 (1 frame). Sits directly after the M.2160 frame: being
% named in the framework is what starts this clock, so say it as a continuation.
% The USRP bench frames that used to open this section live in parked/07_bench_frames.tex.
...
\begin{frame}{Being named starts a clock}
  \vspace{0.3em}
  {\small\raggedright Being written into M.2160 does not ship a product; it starts a
   schedule --- spectrum, requirements, tests, then certification. Here is where that
   schedule stood when this material was prepared.\par}
