...
% is up and to the LEFT. Students read every curve as "up and to the right is better"
% and will get this backwards unless you say it. (The axis is the CRLB in the source
% paper; the acronym is kept out of the main deck for this audience.)
\begin{frame}{The frontier, drawn once}
  ...
  \glossline{Horizontal axis = sensing error: how far off the range and speed estimates
    are. \textbf{Lower is better}, so the good corner is up and to the left.}
