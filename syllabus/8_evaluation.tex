...
%   \item \textbf{Requirement:} Complete \textbf{three} practicums during the semester (total \textbf{15\%}).
  ...
  \item \textbf{Format: Individual presentation only} (one person per practicum). The time allocation depends on the course level:
	\begin{itemize}
	  \item \textbf{For undergraduate students:} 15 minutes presentation + 5 minutes Q\&A.
	  \item \textbf{For graduate students:} 30 minutes presentation + 10 minutes Q\&A.
	\end{itemize}
